    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, axios_1.default.post("http://localhost:3000/v1/chat/completions", {
                ...
                case 3:
                    e_1 = _b.sent();
                    console.error("Test failed as expected or unexpectedly:", ((_a = e_1.response) === null || _a === void 0 ? void 0 : _a.data) || e_1.message);
                    return [3 /*break*/, 4];
